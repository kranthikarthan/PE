 ...
 * Payment Mapper
 * 
 * Maps between Payment domain aggregate and PaymentEntity JPA entity
...
public class PaymentMapper {
    ...
    public PaymentEntity toEntity(Payment payment) {
        return PaymentEntity.builder()
                ...
                .statusHistory(payment.getStatusHistory().stream()
    ...
    public Payment toDomain(PaymentEntity entity) {
        return Payment.builder()
                ...
                .statusHistory(entity.getStatusHistory().stream()
     ...
     */
    private com.payments.domain.payment.StatusChange toStatusChange(PaymentStatusHistoryEntity entity) {
     ...
     */
    private PaymentStatusHistoryEntity toStatusHistoryEntity(com.payments.domain.payment.StatusChange statusChange) {
