 ...
 *
 * <p>Defines the contract for payment persistence operations following the Ports and Adapters
 * pattern
 */
public interface PaymentRepositoryPort {
   ...
   * @return Page of payment aggregates
   */
  Page<Payment> findByTenantIdAndBusinessUnitId(
   ...
   * @return Page of payment aggregates
   */
  Page<Payment> findByTenantIdAndDateRange(
   ...
   * @return Page of payment aggregates
   */
  Page<Payment> findBySourceAccountAndTenantId(
   ...
   * @return Page of payment aggregates
   */
  Page<Payment> findByDestinationAccountAndTenantId(
