 ...
 *
 * <p>Tracks all repair actions performed on payments for audit and compliance. Records who
 * performed what action on which payment and when.
 */
@Entity
@Table(
    name = "payment_repair_log",
    indexes = {
