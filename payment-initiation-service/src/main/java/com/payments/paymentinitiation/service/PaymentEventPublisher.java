 ...
 *
 * <p>Publishes domain events for payment lifecycle events following the Domain-Driven Design
 * pattern
 */
@Slf4j
@Component
...
public class PaymentEventPublisher {
  ...
  public void publishPaymentInitiatedEvent(Payment payment, String correlationId) {
    ...
    event.setPriority(
        com.payments.contracts.payment.Priority.valueOf(payment.getPriority().name()));
   ...
   */
  public void publishPaymentStatusChangedEvent(
      Payment payment, PaymentStatus newStatus, String reason) {
