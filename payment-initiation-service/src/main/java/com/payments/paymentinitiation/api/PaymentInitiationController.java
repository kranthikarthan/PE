 ...
 *
 * <p>Provides endpoints for: - Initiating payments - Retrieving payment status - Health checks
 */
@Slf4j
@RestController
...
public class PaymentInitiationController {
  ...
  public ResponseEntity<PaymentInitiationResponse> initiatePayment(
      @Parameter(description = "Payment initiation request", required = true) @Valid @RequestBody
    ...
    log.info(
        "Initiating payment for tenant: {}, business unit: {}, correlation: {}",
        tenantId,
        businessUnitId,
        correlationId);
  ...
  public ResponseEntity<PaymentInitiationResponse> getPaymentStatus(
      ...
      @Parameter(description = "Business Unit ID", required = true)
          ...
          String businessUnitId) {
    log.info(
        "Retrieving payment status for: {}, tenant: {}, correlation: {}",
        paymentId,
        tenantId,
        correlationId);
  ...
  @PostMapping(value = "/{paymentId}/validate", produces = MediaType.APPLICATION_JSON_VALUE)
  @Operation(
  ...
  public ResponseEntity<PaymentInitiationResponse> validatePayment(
      ...
      @Parameter(description = "Business Unit ID", required = true)
          ...
          String businessUnitId) {
    log.info(
        "Validating payment: {}, tenant: {}, correlation: {}", paymentId, tenantId, correlationId);
  ...
  @PostMapping(
      ...
      consumes = MediaType.APPLICATION_JSON_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE)
  @Operation(summary = "Fail Payment", description = "Mark a payment as failed with reason")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<PaymentInitiationResponse> failPayment(
      ...
      @Parameter(description = "Business Unit ID", required = true)
          ...
          String businessUnitId) {
    log.info(
        "Failing payment: {} with reason: {}, tenant: {}, correlation: {}",
        paymentId,
        failureRequest.getReason(),
        tenantId,
        correlationId);
  ...
  @PostMapping(value = "/{paymentId}/complete", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  public ResponseEntity<PaymentInitiationResponse> completePayment(
      ...
      @Parameter(description = "Business Unit ID", required = true)
          ...
          String businessUnitId) {
    log.info(
        "Completing payment: {}, tenant: {}, correlation: {}", paymentId, tenantId, correlationId);
  ...
  public ResponseEntity<PaymentHistoryResponse> getPaymentHistory(
      ...
      @Parameter(description = "Business Unit ID", required = true)
          ...
          String businessUnitId) {
    log.info(
        "Retrieving payment history for tenant: {}, business unit: {}, correlation: {}",
        tenantId,
        businessUnitId,
        correlationId);
    ...
    try {
      var payments =
          paymentInitiationService.getPaymentHistory(tenantId, businessUnitId, correlationId);

      PaymentHistoryResponse response =
          PaymentHistoryResponse.builder().payments(payments).totalCount(payments.size()).build();
