 ...
 * 
 * Tests JPA repository operations with real database
 */
@DataJpaTest
@ActiveProfiles("test")
class PaymentRepositoryTest {
    ...
    void findByIdAndTenantId_ShouldReturnPayment_WhenPaymentExistsForTenant() {
        // When
        Optional<Payment> result = paymentRepository.findByIdAndTenantId(
                testPayment.getId(), 
    ...
    void findByTenantIdAndDateRange_ShouldReturnPayments_WhenPaymentsExistInRange() {
        ...
        // When
        Page<Payment> result = paymentRepository.findByTenantIdAndDateRange(
                testPayment.getTenantContext().getTenantId(),
                startDate,
                endDate,
                pageRequest
    ...
    void findByTenantIdAndBusinessUnitId_ShouldReturnPayments_WhenPaymentsExist() {
        ...
        // When
        Page<Payment> result = paymentRepository.findByTenantIdAndBusinessUnitId(
                testPayment.getTenantContext().getTenantId(),
