 ...
 * 
 * Tests complete payment flow with real database using Testcontainers
 */
@SpringBootTest
@AutoConfigureWebMvc
@Testcontainers
...
class PaymentInitiationIntegrationTest {
    ...
    void completePaymentFlow_ShouldWorkEndToEnd() throws Exception {
        ...
        String paymentResponse = mockMvc.perform(post("/api/v1/payments/initiate")
        ...
        PaymentInitiationResponse response = objectMapper.readValue(paymentResponse, PaymentInitiationResponse.class);
