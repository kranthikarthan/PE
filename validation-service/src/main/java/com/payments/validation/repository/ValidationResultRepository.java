 ...
 *
 * <p>JPA repository for validation results: - CRUD operations - Custom queries for analytics -
 * Multi-tenant data access - Performance optimized queries
 */
@Repository
public interface ValidationResultRepository extends JpaRepository<ValidationResultEntity, Long> {
  ...
  Page<ValidationResultEntity> findByTenantIdOrderByValidatedAtDesc(
  ...
  Page<ValidationResultEntity> findByTenantIdAndBusinessUnitIdAndStatusOrderByValidatedAtDesc(
      ...
      ValidationResultEntity.ValidationStatus status,
      Pageable pageable);
  ...
  Page<ValidationResultEntity> findByTenantIdAndBusinessUnitIdAndRiskLevelOrderByValidatedAtDesc(
      String tenantId,
      String businessUnitId,
      ValidationResultEntity.RiskLevel riskLevel,
      Pageable pageable);
