 ...
 *
 * <p>JPA entity for validation results persistence: - Validation outcome and metadata - Risk and
 * fraud assessment - Applied and failed rules - Audit trail information
 */
@Entity
@Table(
