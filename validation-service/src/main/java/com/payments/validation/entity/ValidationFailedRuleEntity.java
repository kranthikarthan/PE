 ...
 * 
 * Maps to validation_failed_rules table with:
 * - Failed rule details
 * - Rule execution metadata
 * - Failure reasons and context
 */
@Entity
@Table(name = "validation_failed_rules", indexes = {
    @Index(name = "idx_validation_failed_rules_validation_result_id", columnList = "validation_result_id"),
