 ...
 *
 * <p>Manages rule configuration: - Rule loading and caching - Rule versioning - Rule
 * activation/deactivation - Rule performance monitoring
 */
@Slf4j
@Service
...
public class RuleConfigurationService {
  ...
  public RuleExecutionConfiguration getRuleExecutionConfiguration() {
    return RuleExecutionConfiguration.builder()
        ...
        .maxExecutionTime((int) ruleEngineProperties.getMaxExecutionTime())
