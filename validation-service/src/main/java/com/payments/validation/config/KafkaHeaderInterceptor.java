 ...
 * 
 * Automatically adds correlation and tenant headers to Kafka messages:
...
public class KafkaHeaderInterceptor implements ProducerInterceptor<String, Object> {
    ...
    public ProducerRecord<String, Object> onSend(ProducerRecord<String, Object> record) {
        ...
        record.headers().add("X-Processing-Time", String.valueOf(System.currentTimeMillis()).getBytes());
    ...
    public void onAcknowledgement(RecordMetadata metadata, Exception exception) {
        if (exception != null) {
            log.error("Failed to send message to topic: {}, partition: {}, offset: {}", 
