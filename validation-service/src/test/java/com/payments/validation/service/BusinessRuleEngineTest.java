...
class BusinessRuleEngineTest {
    ...
    void executeRules_WithValidPayment_ShouldPass() {
        ...
        // When
        RuleExecutionFacade.RuleExecutionResult result = businessRuleEngine.executeRules(context, event);

        // Then
        assertThat(result).isNotNull();
        assertThat(result.getRuleType()).isEqualTo(RuleType.BUSINESS);
        assertThat(result.isSuccess()).isTrue();
        assertThat(result.getAppliedRules()).contains("BUSINESS_RULE_001", "BUSINESS_RULE_002", "BUSINESS_RULE_003", "BUSINESS_RULE_004", "BUSINESS_RULE_005");
