...
public class SwiftAdapterController {
  ...
  @PostMapping
  @Operation(summary = "Create SWIFT adapter", description = "Create a new SWIFT adapter configuration")
  public ResponseEntity<SwiftAdapter> createAdapter(@Valid @RequestBody CreateSwiftAdapterRequest request) {
  ...
  @Operation(summary = "Update adapter configuration", description = "Update SWIFT adapter configuration")
  public ResponseEntity<SwiftAdapter> updateAdapterConfiguration(
    ...
    SwiftAdapter adapter = swiftAdapterService.updateAdapterConfiguration(
  ...
  public ResponseEntity<SwiftAdapter> activateAdapter(
      @PathVariable String adapterId,
      @RequestBody ActivateSwiftAdapterRequest request) {
    log.info("Activating SWIFT adapter: {}", adapterId);

    SwiftAdapter adapter = swiftAdapterService.activateAdapter(
        ClearingAdapterId.of(adapterId),
  ...
  public ResponseEntity<SwiftAdapter> deactivateAdapter(
      @PathVariable String adapterId,
      @RequestBody DeactivateSwiftAdapterRequest request) {
    log.info("Deactivating SWIFT adapter: {}", adapterId);

    SwiftAdapter adapter = swiftAdapterService.deactivateAdapter(
        ClearingAdapterId.of(adapterId),
        request.getReason(),
  ...
  @Operation(summary = "Get adapters by tenant", description = "Get all SWIFT adapters for a tenant")
  ...
  @Operation(summary = "Get active adapters by tenant", description = "Get active SWIFT adapters for a tenant")
  public ResponseEntity<List<SwiftAdapter>> getActiveAdaptersByTenant(@PathVariable String tenantId) {
