 ...
 *
 * <p>Environment-specific configuration for SWIFT adapter: - Development environment settings -
 * Staging environment settings - Production environment settings - Environment-specific endpoints
 * and credentials
 */
@Data
@Configuration
@ConfigurationProperties(prefix = "swift.environment")
public class SwiftEnvironmentConfig {
