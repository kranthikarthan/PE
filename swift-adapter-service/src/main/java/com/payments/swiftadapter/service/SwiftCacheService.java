 ...
 * SWIFT Cache Service
 *
 * <p>Service for managing SWIFT cache operations including statistics, clearing, and health checks.
 */
@Slf4j
@Service
public class SwiftCacheService {
  ...
  public CacheStatistics getCacheStatistics() {
    log.debug("Getting SWIFT cache statistics");
  ...
  public boolean isCacheHealthy() {
    log.debug("Checking SWIFT cache health");
