 ...
 * 
 * Tests verify that all exception scenarios are properly handled:
...
class ExceptionHandlingTest {
  ...
  class NotFoundExceptionTests {
    ...
    void shouldThrowNotFoundExceptionWhenActivatingNonExistent() {
      ...
      // When & Then
      assertThatThrownBy(() ->
          swiftAdapterService.activateAdapter(nonExistentId, "user")
      )
          .isInstanceOf(SwiftAdapterNotFoundException.class);
    }

    @Test
    @DisplayName("Should throw SwiftAdapterNotFoundException when deactivating non-existent adapter")
  ...
  class InvalidInputValidationTests {
    ...
    void shouldHandleNullAdapterName() {
      ...
      var tenantContext = com.payments.swiftadapter.fixtures.TenantContextTestDataBuilder
          .aTenantContext().build();
    ...
    void shouldValidateNegativeTimeoutSeconds() {
      // Given
      var adapterId = ClearingAdapterId.generate();
      var adapter = SwiftAdapterTestDataBuilder.aSwiftAdapter()
          .withId(adapterId)
  ...
  class RepositoryFailureTests {
    ...
    void shouldHandleRepositoryExceptionDuringSave() {
      ...
      assertThatThrownBy(() ->
          swiftAdapterService.createAdapter(
              adapterId, tenantContext, "Adapter", "https://endpoint.com", "user").get()
      )
    ...
    void shouldHandleRepositoryExceptionDuringFind() {
      ...
      // When & Then
      assertThatThrownBy(() ->
          swiftAdapterService.getAdapter(adapterId)
      )
    ...
    void shouldHandleRepositoryExceptionDuringDelete() {
      ...
      doThrow(new RuntimeException("Delete failed"))
          .when(mockRepository).deleteById(adapterId);
  ...
  class ConcurrentAccessTests {
    ...
    void shouldHandleConcurrentCreation() throws ExecutionException, InterruptedException {
      ...
      // When
      CompletableFuture<SwiftAdapter> future1 = swiftAdapterService.createAdapter(
          adapterId1, tenantContext, "Adapter 1", "https://endpoint1.com", "user");
      CompletableFuture<SwiftAdapter> future2 = swiftAdapterService.createAdapter(
    ...
    void shouldHandleConcurrentRetrieval() throws ExecutionException, InterruptedException {
      ...
      // When
      CompletableFuture<Optional<SwiftAdapter>> future1 = CompletableFuture
          .supplyAsync(() -> swiftAdapterService.getAdapter(adapterId));
      CompletableFuture<Optional<SwiftAdapter>> future2 = CompletableFuture
          .supplyAsync(() -> swiftAdapterService.getAdapter(adapterId));
  ...
  class StateTransitionTests {
    ...
    void shouldHandleActivationOfAlreadyActiveAdapter() {
      ...
      var resultAdapter = SwiftAdapterTestDataBuilder.aSwiftAdapter()
          .withId(adapterId)
          .active()
          .build();
  ...
  class DataIntegrityTests {
    ...
    void shouldPreserveAdapterIdAfterUpdate() {
      ...
      SwiftAdapter result = swiftAdapterService.updateAdapterConfiguration(
          adapterId, "https://new.endpoint.com", "2.0", 30, 3, true, 100, "09:00", "17:00", "user");
