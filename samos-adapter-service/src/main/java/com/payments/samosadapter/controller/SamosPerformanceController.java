 ...
 *
 * <p>REST controller for SAMOS performance optimization operations: - Performance metrics - Optimization recommendations - Cache management - Resource optimization
 */
@Slf4j
@RestController
...
public class SamosPerformanceController {
  ...
  public ResponseEntity<Map<String, Object>> getOptimizationRecommendations() {
    ...
    Map<String, Object> recommendations = samosPerformanceOptimizationService.getOptimizationRecommendations();
  ...
  public ResponseEntity<Map<String, Object>> evictAdapterCache(@PathVariable String adapterId) {
    ...
    Map<String, Object> result = Map.of(
        "status", "SUCCESS",
        "message", "SAMOS adapter cache evicted successfully",
        "adapterId", adapterId,
        "timestamp", java.time.Instant.now().toString()
    );
