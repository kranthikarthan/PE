 ...
 *
 * <p>REST controller for SAMOS cache management operations: - Cache statistics - Cache clearing - Token management - Cache health
 */
@Slf4j
@RestController
...
public class SamosCacheManagementController {
  ...
  @Operation(summary = "Clear SAMOS adapter cache", description = "Clear cache for specific SAMOS adapter")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<Map<String, Object>> clearAllCache() {
    ...
    return ResponseEntity.ok(
        Map.of(
            "message", "All SAMOS cache cleared successfully", "timestamp", System.currentTimeMillis()));
  }
  ...
  @Operation(summary = "Clear SAMOS OAuth2 token cache", description = "Clear SAMOS OAuth2 token cache")
  @ApiResponses(
      value = {
  ...
  @Operation(summary = "Refresh SAMOS OAuth2 token", description = "Refresh SAMOS OAuth2 access token")
  @ApiResponses(
      value = {
  ...
  @Operation(summary = "Get SAMOS OAuth2 token info", description = "Get SAMOS OAuth2 token information")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
