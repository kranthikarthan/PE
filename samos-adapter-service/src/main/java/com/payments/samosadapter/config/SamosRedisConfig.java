...
public class SamosRedisConfig {
  ...
  public RedisConnectionFactory redisConnectionFactory() {
    ...
    log.info("SAMOS Redis connection factory configured: {}:{}", redisHost, redisPort);
    return factory;
  }
  ...
  public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory connectionFactory) {
    ...
    log.info("SAMOS Redis template configured with Jackson serializers");
    return template;
  }
}
