...
class BalanceValidationServiceTest {
    ...
    void validateSufficientBalance_ShouldReturnTrue_WhenSufficientBalance() {
        ...
        // When
        boolean result = balanceValidationService.validateSufficientBalance(account1, tenantContext, amount);
    ...
    private Transaction createBalancedTransaction() {
        ...
        Transaction transaction = Transaction.create(
            transactionId, tenantContext, PaymentId.of("pay-123"), 
            account1, account2, amount, TransactionType.PAYMENT
        );
        return transaction;
    }
