...
class TransactionServiceTest {
  ...
  @Mock private TransactionEventService eventService;

  @Mock private BalanceValidationService balanceValidationService;
  ...
  void setUp() {
    transactionService =
        new TransactionService(
            transactionRepository, ledgerService, eventService, balanceValidationService);
  ...
  void createTransaction_ShouldCreateTransactionSuccessfully() {
    ...
    when(balanceValidationService.validateDoubleEntryInvariants(any(Transaction.class)))
        .thenReturn(true);
    when(balanceValidationService.validateSufficientBalance(
            any(AccountNumber.class), any(TenantContext.class), any(Money.class)))
        .thenReturn(true);
    when(balanceValidationService.validateAccountBalances(any(Transaction.class))).thenReturn(true);
