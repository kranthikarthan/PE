...
public class TransactionEventPublisher {
    ...
    public void publishEvent(TransactionEvent event) {
        log.debug("Publishing event {} for transaction {}", 
                event.getEventType(), event.getTransactionId().getValue());
        ...
        try {
            ...
            kafkaTemplate.send(topic, key, eventPayload)
                    .whenComplete((result, ex) -> {
                        if (ex == null) {
                            log.debug("Event {} published successfully to topic {}", 
            ...
            log.error("Error publishing event {} for transaction {}", 
                    event.getEventType(), event.getTransactionId().getValue(), e);
    ...
    public void publishTransactionCreated(TransactionCreatedEvent event) {
        log.info("Publishing transaction created event for transaction {}", 
    ...
    public void publishTransactionProcessing(TransactionProcessingEvent event) {
        log.info("Publishing transaction processing event for transaction {}", 
                event.getTransactionId().getValue());
    ...
    public void publishTransactionClearing(TransactionClearingEvent event) {
        log.info("Publishing transaction clearing event for transaction {}", 
                event.getTransactionId().getValue());
    ...
    public void publishTransactionCompleted(TransactionCompletedEvent event) {
        log.info("Publishing transaction completed event for transaction {}", 
                event.getTransactionId().getValue());
    ...
    public void publishTransactionFailed(TransactionFailedEvent event) {
        log.info("Publishing transaction failed event for transaction {}", 
                event.getTransactionId().getValue());
