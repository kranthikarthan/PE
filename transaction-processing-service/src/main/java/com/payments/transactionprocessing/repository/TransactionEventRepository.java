...
public interface TransactionEventRepository
    extends JpaRepository<TransactionEventEntity, TransactionEventId> {
  ...
  @Query(
      "SELECT te FROM TransactionEventEntity te WHERE te.tenantContext = :tenantContext "
  ...
  @Query(
      "SELECT te FROM TransactionEventEntity te WHERE te.correlationId = :correlationId "
  ...
  @Query(
      "SELECT MAX(te.eventSequence) FROM TransactionEventEntity te WHERE te.transaction.id = :transactionId")
