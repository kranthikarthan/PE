 ...
 * Routing Request DTO
 * 
 * Input for routing decision engine:
 * - Payment attributes (amount, currency, type)
 * - Tenant context (tenant ID, business unit ID)
 * - Account information (source, destination)
 * - Processing preferences (priority, mode)
 * - Custom metadata
 * 
 * Validation: Jakarta validation annotations
 * Performance: Immutable DTO with builder pattern
 */
@Data
@Builder
