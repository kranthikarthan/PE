 ...
 * 
 * Defines the operators for routing conditions:
 * - EQUALS: Field equals value
 * - NOT_EQUALS: Field does not equal value
 * - GREATER_THAN: Field is greater than value
 * - GREATER_THAN_OR_EQUALS: Field is greater than or equal to value
 * - LESS_THAN: Field is less than value
 * - LESS_THAN_OR_EQUALS: Field is less than or equal to value
 ...
 * - NOT_REGEX: Field does not match regex pattern
 */
