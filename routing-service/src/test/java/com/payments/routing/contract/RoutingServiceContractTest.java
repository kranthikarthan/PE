 ...
 * 
 * Contract tests for the routing service API:
...
public class RoutingServiceContractTest {
    ...
    void shouldGetRoutingDecisionSuccessfully() {
        ...
        // When
        ResponseEntity<RoutingDecision> response = restTemplate.exchange(
                baseUrl + "/decisions",
                HttpMethod.POST,
                entity,
    ...
    void shouldGetRoutingStatistics() {
        ...
        // When
        ResponseEntity<RoutingStatistics> response = restTemplate.exchange(
                baseUrl + "/statistics",
                HttpMethod.GET,
                entity,
                RoutingStatistics.class
        );
