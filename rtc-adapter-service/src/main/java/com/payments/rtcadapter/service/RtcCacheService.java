...
public class RtcCacheService {

  private final RedisTemplate<String, Object> redisTemplate;
  private final AtomicLong cacheHits = new AtomicLong(0);
  private final AtomicLong cacheMisses = new AtomicLong(0);

  private static final String CACHE_PREFIX = "rtc:";
  ...
  public void clearAdapterCache(String adapterId, String tenantId) {
    ...
    log.info("Cleared RTC adapter cache: {}", cacheKey);
  }
  ...
  public void clearTenantCache(String tenantId) {
    ...
    if (keys != null && !keys.isEmpty()) {
      ...
      log.info("Cleared RTC tenant cache: {} - Count: {}", tenantId, keys.size());
    }
  }
  ...
  public void clearAllCache() {
    ...
    if (keys != null && !keys.isEmpty()) {
      redisTemplate.delete(keys);
      log.info("Cleared all RTC cache - Count: {}", keys.size());
    }
  }
