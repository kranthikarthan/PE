 ...
 *
 * <p>Advanced monitoring service for RTC adapter: - Custom metrics collection - Performance
...
public class RtcMonitoringService {
  ...
  public RtcMonitoringService(
    ...
    // Initialize counters
    this.rtcTransactionCounter =
        Counter.builder("rtc.transactions.total")
            .description("Total number of RTC transactions")
            .register(meterRegistry);

    this.rtcErrorCounter =
        Counter.builder("rtc.errors.total")
            .description("Total number of RTC errors")
            .register(meterRegistry);

    this.rtcComplianceCheckCounter =
        Counter.builder("rtc.compliance.checks.total")
            .description("Total number of RTC compliance checks")
            .register(meterRegistry);

    this.rtcFraudDetectionCounter =
        Counter.builder("rtc.fraud.detections.total")
            .description("Total number of RTC fraud detections")
            .register(meterRegistry);

    this.rtcRiskAssessmentCounter =
        Counter.builder("rtc.risk.assessments.total")
            .description("Total number of RTC risk assessments")
            .register(meterRegistry);

    this.rtcRealTimeProcessingCounter =
        Counter.builder("rtc.realtime.processing.total")
            .description("Total number of RTC real-time processing operations")
            .register(meterRegistry);

    // Initialize timers
    this.rtcTransactionTimer =
        Timer.builder("rtc.transactions.duration")
            .description("RTC transaction processing duration")
            .register(meterRegistry);

    this.rtcComplianceTimer =
        Timer.builder("rtc.compliance.duration")
            .description("RTC compliance check duration")
            .register(meterRegistry);

    this.rtcFraudDetectionTimer =
        Timer.builder("rtc.fraud.detection.duration")
            .description("RTC fraud detection duration")
            .register(meterRegistry);

    this.rtcRiskAssessmentTimer =
        Timer.builder("rtc.risk.assessment.duration")
            .description("RTC risk assessment duration")
            .register(meterRegistry);

    this.rtcRealTimeProcessingTimer =
        Timer.builder("rtc.realtime.processing.duration")
  ...
  public void recordTransaction(String transactionId, boolean success, long durationMs) {
    ...
    log.debug(
        "Recorded RTC transaction metrics: transactionId={}, success={}, duration={}ms",
        transactionId,
        success,
        durationMs);
  }
  ...
  public void recordComplianceCheck(String adapterId, boolean compliant, long durationMs) {
    ...
    log.debug(
        "Recorded RTC compliance check metrics: adapterId={}, compliant={}, duration={}ms",
        adapterId,
        compliant,
        durationMs);
  }
  ...
  public void recordFraudDetection(String adapterId, boolean fraudDetected, long durationMs) {
    ...
    log.debug(
        "Recorded RTC fraud detection metrics: adapterId={}, fraudDetected={}, duration={}ms",
        adapterId,
        fraudDetected,
        durationMs);
  }
  ...
  public void recordRiskAssessment(String adapterId, String riskLevel, long durationMs) {
    ...
    log.debug(
        "Recorded RTC risk assessment metrics: adapterId={}, riskLevel={}, duration={}ms",
        adapterId,
        riskLevel,
        durationMs);
  }
  ...
  public void recordRealTimeProcessing(String transactionId, long durationMs) {
    ...
    log.debug(
        "Recorded RTC real-time processing metrics: transactionId={}, duration={}ms",
        transactionId,
        durationMs);
  }
  ...
  public Map<String, Object> getDashboardMetrics() {
    ...
    metrics.put(
        ...
        rtcTransactionTimer.mean(java.util.concurrent.TimeUnit.MILLISECONDS));
    metrics.put(
        "averageComplianceTime",
        rtcComplianceTimer.mean(java.util.concurrent.TimeUnit.MILLISECONDS));
    metrics.put(
        "averageFraudDetectionTime",
        rtcFraudDetectionTimer.mean(java.util.concurrent.TimeUnit.MILLISECONDS));
    metrics.put(
        "averageRiskAssessmentTime",
        rtcRiskAssessmentTimer.mean(java.util.concurrent.TimeUnit.MILLISECONDS));
    metrics.put(
        "averageRealTimeProcessingTime",
        rtcRealTimeProcessingTimer.mean(java.util.concurrent.TimeUnit.MILLISECONDS));
  ...
  public Map<String, Object> getPerformanceMetrics() {
    ...
    performance.put(
        ...
        rtcTransactionTimer.mean(java.util.concurrent.TimeUnit.MILLISECONDS));
    performance.put(
        "maxTransactionTime", rtcTransactionTimer.max(java.util.concurrent.TimeUnit.MILLISECONDS));
    performance.put(
        "averageComplianceTime",
        rtcComplianceTimer.mean(java.util.concurrent.TimeUnit.MILLISECONDS));
    performance.put(
