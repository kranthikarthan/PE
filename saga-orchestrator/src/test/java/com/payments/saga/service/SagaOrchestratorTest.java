...
class SagaOrchestratorTest {
  ...
  @Mock private SagaTemplateService sagaTemplateService;

  @Mock private SagaExecutionEngine sagaExecutionEngine;

  @Mock private SagaCompensationEngine sagaCompensationEngine;
    ...
    assertThrows(
        ...
        () ->
            sagaOrchestrator.startSaga(
                templateName, tenantContext, "corr-123", "pay-456", Map.of()));
  }
  ...
  void testExecuteNextStep_SagaNotFound() {
    ...
    // When & Then
    assertThrows(IllegalArgumentException.class, () -> sagaOrchestrator.executeNextStep(sagaId));
  }
