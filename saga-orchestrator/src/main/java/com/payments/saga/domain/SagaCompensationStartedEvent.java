...
public class SagaCompensationStartedEvent extends SagaEvent {
    ...
    public SagaCompensationStartedEvent(SagaId sagaId, TenantContext tenantContext, String correlationId,
                                      String sagaName, String paymentId, String reason, int stepsToCompensate) {
