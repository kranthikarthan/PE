...
public class SagaTemplate {
  ...
  public List<SagaStepDefinition> getBusinessSteps() {
    return stepDefinitions.stream().filter(SagaStepDefinition::isBusinessStep).toList();
  }

  public List<SagaStepDefinition> getCompensationSteps() {
    return stepDefinitions.stream().filter(SagaStepDefinition::isCompensationStep).toList();
  }
