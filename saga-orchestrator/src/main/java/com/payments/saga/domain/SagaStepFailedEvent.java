...
public class SagaStepFailedEvent extends SagaEvent {
    ...
    public SagaStepFailedEvent(SagaId sagaId, TenantContext tenantContext, String correlationId,
                             String stepName, SagaStepType stepType, int sequence, 
                             String serviceName, String errorMessage, Map<String, Object> errorData,
