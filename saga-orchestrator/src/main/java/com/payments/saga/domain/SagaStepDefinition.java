...
public class SagaStepDefinition {
  ...
  public static SagaStepDefinition create(
      String stepName,
  ...
  public static SagaStepDefinition createCompensation(
      String stepName, SagaStepType stepType, String serviceName, String compensationEndpoint) {
    return SagaStepDefinition.builder()
        .stepName(stepName)
        .stepType(stepType)
        .serviceName(serviceName)
