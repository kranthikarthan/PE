...
public class SagaExecutionEngine {
    ...
    public void executeStep(SagaStep step) {
        log.info("Executing step {} ({}) for saga {}", 
                step.getStepName(), step.getStepType(), step.getSagaId().getValue());
    ...
    private Map<String, Object> executeAccountAdapterStep(SagaStep step) {
        ...
        try {
            ...
            log.debug("Account adapter step {} completed with response: {}", step.getStepName(), response);
    ...
    private Map<String, Object> executeTransactionProcessingStep(SagaStep step) {
        ...
        try {
            ...
            log.debug("Transaction processing step {} completed with response: {}", step.getStepName(), response);
