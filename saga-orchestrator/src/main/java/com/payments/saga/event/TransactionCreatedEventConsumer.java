...
public class TransactionCreatedEventConsumer {
    ...
    public void handleTransactionCreated(
        ...
        try {
            log.info("Received TransactionCreatedEvent from topic {} (partition: {}, offset: {})", topic, partition, offset);
            ...
            log.info("Transaction {} created for payment {} with status: {}", transactionId, paymentId, status);
