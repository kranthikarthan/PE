...
import com.paymentengine.corebanking.dto.MultiLevelAuthConfigurationDTO;
import com.paymentengine.corebanking.dto.ConfigurationHierarchyDTO;
import com.paymentengine.corebanking.dto.ResolvedAuthConfigurationDTO;
...
/**
 * Service for managing multi-level authentication configuration in Core Banking Service
...
public class MultiLevelAuthConfigurationService {
    ...
    public Optional<MultiLevelAuthConfigurationDTO> getMultiLevelAuthConfiguration(String tenantId) {
        ...
        try {
            ...
            config.setTenantName("Core Banking Tenant");
    ...
    public Optional<ConfigurationHierarchyDTO> getConfigurationHierarchy(String tenantId) {
        ...
        try {
            ...
            hierarchy.setTenantName("Core Banking Tenant");
