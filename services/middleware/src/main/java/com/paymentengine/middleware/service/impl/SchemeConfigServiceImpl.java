...
public class SchemeConfigServiceImpl implements SchemeConfigService {
    ...
    public SchemeTestResponse testConfiguration(SchemeTestRequest request) {
        ...
        try {
            ...
            if (Boolean.TRUE.equals(request.getValidateOnly())) {
                ...
                CompletableFuture<com.paymentengine.middleware.dto.SchemeMessageResponse> future = 
                        schemeMessageService.sendAsyncMessage(request.getConfigId(), request.getTestMessage());
                
                com.paymentengine.middleware.dto.SchemeMessageResponse response = future.get();
                long responseTime = System.currentTimeMillis() - startTime;
                
                SchemeTestResponse testResponse = new SchemeTestResponse(
                        response.getStatus() == com.paymentengine.middleware.dto.SchemeMessageResponse.MessageStatus.SUCCESS,
                        responseTime,
                        response,
            ...
            com.paymentengine.middleware.dto.SchemeMessageResponse.ErrorDetails errorDetails = 
                    new com.paymentengine.middleware.dto.SchemeMessageResponse.ErrorDetails(
                            "TEST_ERROR",
                            e.getMessage(),
                            com.paymentengine.middleware.dto.SchemeMessageResponse.ErrorDetails.ErrorCategory.PROCESSING,
                            false,
    ...
    @Override
    public com.paymentengine.middleware.dto.SchemeMessageRequest createMessageFromTemplate(
        ...
        return new com.paymentengine.middleware.dto.SchemeMessageRequest(
                "pain001",
    ...
    private void initializeDefaultConfigurations() {
        ...
        SchemeConfigResponse defaultConfig1 = new SchemeConfigResponse(
                ...
                com.paymentengine.middleware.dto.SchemeConfigRequest.InteractionMode.SYNCHRONOUS,
                com.paymentengine.middleware.dto.SchemeConfigRequest.MessageFormat.JSON,
                com.paymentengine.middleware.dto.SchemeConfigRequest.ResponseMode.IMMEDIATE,
                10000L,
                new com.paymentengine.middleware.dto.SchemeConfigRequest.RetryPolicy(3, 1000L, true, Arrays.asList(500, 502, 503, 504)),
                new com.paymentengine.middleware.dto.SchemeConfigRequest.AuthenticationConfig(
                        com.paymentengine.middleware.dto.SchemeConfigRequest.AuthenticationConfig.AuthType.API_KEY
                ),
                Arrays.asList(
                        new com.paymentengine.middleware.dto.SchemeConfigRequest.EndpointConfig(
                                "Primary Endpoint",
                                "https://api.scheme.com/v1/payments",
                                com.paymentengine.middleware.dto.SchemeConfigRequest.EndpointConfig.HttpMethod.POST,
                                true,
                                10000L,
