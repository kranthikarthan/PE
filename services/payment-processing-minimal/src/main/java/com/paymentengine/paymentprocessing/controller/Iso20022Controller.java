...
public class Iso20022Controller {
    ...
    public Iso20022Controller(RestTemplate restTemplate) {
        this.uetrGenerationService = new UetrGenerationService();
        this.iso20022MessageService = new Iso20022MessageService();
    }
