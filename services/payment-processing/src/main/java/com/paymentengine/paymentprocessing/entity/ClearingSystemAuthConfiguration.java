...
/**
 * Entity for clearing system level authentication configuration
 * This is the highest level configuration that applies to all clearing operations
 */
@Entity
@Table(name = "clearing_system_auth_configuration", indexes = {
        @Index(name = "idx_clearing_system_auth_active", columnList = "isActive"),
        @Index(name = "idx_clearing_system_auth_environment", columnList = "environment")
})
public class ClearingSystemAuthConfiguration {
    ...
    @ElementCollection
    @CollectionTable(name = "clearing_system_auth_configuration_metadata", joinColumns = @JoinColumn(name = "clearing_system_auth_configuration_id"))
    ...
    // Constructors
    public ClearingSystemAuthConfiguration() {}
