...
public class SchemeInteractionController {
    ...
    public ResponseEntity<SchemeMessageResponse> sendSynchronousJsonMessage(
        ...
        try {
            ...
            if (config.getInteractionMode() != com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.InteractionMode.SYNCHRONOUS &&
                config.getInteractionMode() != com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.InteractionMode.HYBRID) {
                return ResponseEntity.badRequest().body(createErrorResponse(
    ...
    public ResponseEntity<String> sendSynchronousXmlMessage(
        ...
        try {
            ...
            SchemeMessageRequest request = createMessageRequest(
                    messageType, messagePayload, 
                    com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.MessageFormat.XML,
                    com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.InteractionMode.SYNCHRONOUS
            );
    ...
    public ResponseEntity<Map<String, Object>> sendAsynchronousJsonMessage(
        ...
        try {
            ...
            if (config.getInteractionMode() != com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.InteractionMode.ASYNCHRONOUS &&
                config.getInteractionMode() != com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.InteractionMode.HYBRID) {
                return ResponseEntity.badRequest().body(Map.of(
            ...
            SchemeMessageRequest request = createMessageRequest(
                    messageType, messagePayload, 
                    com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.MessageFormat.JSON,
                    com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.InteractionMode.ASYNCHRONOUS
            );
    ...
    public ResponseEntity<Object> convertMessageFormat(
        ...
        try {
            com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.MessageFormat from = 
                    com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.MessageFormat.valueOf(fromFormat.toUpperCase());
            com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.MessageFormat to = 
                    com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.MessageFormat.valueOf(toFormat.toUpperCase());
    ...
    private SchemeMessageRequest createMessageRequest(
            ...
            com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.MessageFormat format,
            com.paymentengine.paymentprocessing.dto.SchemeConfigRequest.InteractionMode interactionMode) {
