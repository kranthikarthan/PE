...
import com.paymentengine.paymentprocessing.service.ExternalFraudApiService;
...
public class ExternalFraudApiServiceImpl implements ExternalFraudApiService {
    ...
    public Map<String, Object> callBankFraudApi(
        ...
        try {
            ...
            if (bankFraudApiConfig.containsKey("authHeader")) {
                headers.set("Authorization", (String) bankFraudApiConfig.get("authHeader"));
            }
            ...
            logger.error("REST client error calling bank's fraud/risk monitoring engine: {}", e.getMessage(), e);
