...
public class LoggingService {
  ...
  public <T> T executeWithTenantContext(
      String tenantId, String businessUnitId, Supplier<T> operation) {
    try {
  ...
  public <T> T executeWithPaymentContext(
      String paymentId, String paymentType, Supplier<T> operation) {
    try {
  ...
  public <T> T executeWithSagaContext(
      String sagaId, String sagaName, String stepName, Supplier<T> operation) {
    try {
  ...
  public void logPaymentInitiated(
      String paymentId, String tenantId, String paymentType, String amount) {
    log.info(
        "Payment initiated: paymentId={}, tenantId={}, paymentType={}, amount={}",
        paymentId,
        tenantId,
        paymentType,
        amount);
  ...
  public void logPaymentCompleted(String paymentId, String tenantId, String status) {
    log.info(
        "Payment completed: paymentId={}, tenantId={}, status={}", paymentId, tenantId, status);
  }

  /** Log payment failure */
  public void logPaymentFailed(
      String paymentId, String tenantId, String errorType, String errorMessage) {
    log.error(
        "Payment failed: paymentId={}, tenantId={}, errorType={}, errorMessage={}",
        paymentId,
        tenantId,
        errorType,
        errorMessage);
  ...
  public void logSagaStarted(String sagaId, String templateName, String paymentId) {
    log.info(
        "Saga started: sagaId={}, templateName={}, paymentId={}", sagaId, templateName, paymentId);
  }

  /** Log saga step started */
  public void logSagaStepStarted(String sagaId, String stepName, String stepType) {
    log.info("Saga step started: sagaId={}, stepName={}, stepType={}", sagaId, stepName, stepType);
  }

  /** Log saga step completed */
  public void logSagaStepCompleted(String sagaId, String stepName, String stepType) {
    log.info(
        "Saga step completed: sagaId={}, stepName={}, stepType={}", sagaId, stepName, stepType);
  }

  /** Log saga step failed */
  public void logSagaStepFailed(
      String sagaId, String stepName, String stepType, String errorMessage) {
    log.error(
        "Saga step failed: sagaId={}, stepName={}, stepType={}, errorMessage={}",
        sagaId,
        stepName,
        stepType,
        errorMessage);
  ...
  public void logSagaCompleted(String sagaId, String templateName, String paymentId) {
    log.info(
        "Saga completed: sagaId={}, templateName={}, paymentId={}",
        sagaId,
        templateName,
        paymentId);
  }
  ...
  public void logSagaCompensationStarted(String sagaId, String templateName, String reason) {
    log.warn(
        "Saga compensation started: sagaId={}, templateName={}, reason={}",
        sagaId,
        templateName,
        reason);
  }
  ...
  public void logSagaCompensated(String sagaId, String templateName, String paymentId) {
    log.info(
        "Saga compensated: sagaId={}, templateName={}, paymentId={}",
        sagaId,
        templateName,
        paymentId);
  }
  ...
  public void logExternalServiceCall(String serviceName, String operation, String endpoint) {
    log.debug(
        "External service call: serviceName={}, operation={}, endpoint={}",
        serviceName,
        operation,
        endpoint);
  }
  ...
  public void logExternalServiceCallSuccess(String serviceName, String operation, long duration) {
    log.debug(
        "External service call success: serviceName={}, operation={}, duration={}ms",
        serviceName,
        operation,
        duration);
  }
  ...
  public void logExternalServiceCallFailure(
      String serviceName, String operation, String errorMessage) {
    log.error(
        "External service call failure: serviceName={}, operation={}, errorMessage={}",
        serviceName,
        operation,
        errorMessage);
  }
  ...
  public void logDatabaseOperation(String operation, String table, String entityId) {
    log.debug(
        "Database operation: operation={}, table={}, entityId={}", operation, table, entityId);
  }

  /** Log cache operation */
  public void logCacheOperation(String operation, String cacheName, String key) {
    log.debug("Cache operation: operation={}, cacheName={}, key={}", operation, cacheName, key);
  }

  /** Log Kafka operation */
  public void logKafkaOperation(String operation, String topic, String key) {
    log.debug("Kafka operation: operation={}, topic={}, key={}", operation, topic, key);
  }

  /** Log business event */
  public void logBusinessEvent(
      String eventType, String entityType, String entityId, Map<String, Object> data) {
    log.info(
        "Business event: eventType={}, entityType={}, entityId={}, data={}",
        eventType,
        entityType,
        entityId,
        data);
  ...
  public void logSecurityEvent(String eventType, String userId, String action, String resource) {
    log.warn(
        "Security event: eventType={}, userId={}, action={}, resource={}",
        eventType,
        userId,
        action,
        resource);
  ...
  public void logPerformanceMetric(
      String metricName, long value, String unit, Map<String, String> tags) {
    log.info(
        "Performance metric: metricName={}, value={}, unit={}, tags={}",
        metricName,
        value,
        unit,
        tags);
