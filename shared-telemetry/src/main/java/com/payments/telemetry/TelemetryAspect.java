...
public class TelemetryAspect {
    ...
    public Object traceServiceMethod(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        return tracingService.executeInSpan(spanName, () -> {
            try {
            ...
            return metricsService.recordTiming("service.method.duration", 
    ...
    public Object traceExternalService(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        return tracingService.executeExternalSpan(spanName, className, methodName, () -> {
            try {
                ...
                return metricsService.recordExternalServiceCall(className, methodName, () -> {
                    try {
                        Object result = joinPoint.proceed();
                        loggingService.logExternalServiceCallSuccess(className, methodName, 0);
                        return result;
                    } catch (Throwable throwable) {
                        loggingService.logExternalServiceCallFailure(className, methodName, throwable.getMessage());
                        throw new RuntimeException(throwable);
                    }
                });
            } catch (Exception e) {
    ...
    public Object traceDatabaseOperation(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        return tracingService.executeInSpan(spanName, () -> {
            try {
                ...
                return metricsService.recordDatabaseOperation(methodName, className, () -> {
                    try {
                        Object result = joinPoint.proceed();
    ...
    public Object traceCacheOperation(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        return tracingService.executeInSpan(spanName, () -> {
            try {
                ...
                return metricsService.recordCacheOperation(methodName, className, () -> {
                    try {
                        Object result = joinPoint.proceed();
    ...
    public Object traceKafkaOperation(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        return tracingService.executeInSpan(spanName, () -> {
            try {
                ...
                return metricsService.recordKafkaOperation(methodName, className, () -> {
                    try {
                        Object result = joinPoint.proceed();
