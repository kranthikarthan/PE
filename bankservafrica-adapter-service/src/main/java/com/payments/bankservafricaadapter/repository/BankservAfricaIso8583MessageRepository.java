 ...
 */
@Repository
public interface BankservAfricaIso8583MessageRepository extends JpaRepository<BankservAfricaIso8583Message, ClearingMessageId> {
     ...
     */
    @Query("SELECT m FROM BankservAfricaIso8583Message m WHERE m.bankservafricaAdapterId = :adapterId")
     ...
     */
    List<BankservAfricaIso8583Message> findByAmountBetween(BigDecimal minAmount, BigDecimal maxAmount);
