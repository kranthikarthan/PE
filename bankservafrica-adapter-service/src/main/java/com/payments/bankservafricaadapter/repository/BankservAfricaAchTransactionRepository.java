 ...
 */
@Repository
public interface BankservAfricaAchTransactionRepository extends JpaRepository<BankservAfricaAchTransaction, ClearingMessageId> {
     ...
     */
    @Query("SELECT t FROM BankservAfricaAchTransaction t WHERE t.bankservafricaAdapterId = :adapterId")
     ...
     */
    List<BankservAfricaAchTransaction> findByAmountBetween(BigDecimal minAmount, BigDecimal maxAmount);
