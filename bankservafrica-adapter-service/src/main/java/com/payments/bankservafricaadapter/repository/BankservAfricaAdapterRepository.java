...
@Repository
public interface BankservAfricaAdapterRepository
    extends JpaRepository<BankservAfricaAdapter, ClearingAdapterId> {

  /** Find adapter by tenant context and adapter name */
  @Query(
      "SELECT a FROM BankservAfricaAdapter a WHERE a.tenantContext.tenantId = :tenantId AND a.adapterName = :adapterName")
  ...
  @Query(
      "SELECT a FROM BankservAfricaAdapter a WHERE a.tenantContext.tenantId = :tenantId AND a.tenantContext.businessUnitId = :businessUnitId")
  ...
  @Query(
      "SELECT a FROM BankservAfricaAdapter a WHERE a.tenantContext.tenantId = :tenantId AND a.status = 'ACTIVE'")
