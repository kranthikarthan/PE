...
public class BankservAfricaEftProcessingController {
    ...
    public ResponseEntity<BankservAfricaEftMessage> processEftBatch(
        ...
        BankservAfricaEftMessage message = eftProcessingService.processEftBatch(
    ...
    public ResponseEntity<BankservAfricaEftMessage> updateEftMessageStatus(
        ...
        BankservAfricaEftMessage message = eftProcessingService.updateEftMessageStatus(
    ...
    public ResponseEntity<BankservAfricaEftMessage> getEftMessage(
        ...
        Optional<BankservAfricaEftMessage> message = eftProcessingService.getEftMessage(
                ClearingMessageId.of(messageId));
    ...
    @Operation(summary = "Get EFT messages by adapter ID", description = "Get EFT messages by adapter ID")
    public ResponseEntity<List<BankservAfricaEftMessage>> getEftMessagesByAdapterId(
        ...
        List<BankservAfricaEftMessage> messages = eftProcessingService.getEftMessagesByAdapterId(
    ...
    @Operation(summary = "Get EFT messages by direction", description = "Get EFT messages by direction")
    public ResponseEntity<List<BankservAfricaEftMessage>> getEftMessagesByDirection(
        ...
        List<BankservAfricaEftMessage> messages = eftProcessingService.getEftMessagesByDirection(direction);
    ...
    @Operation(summary = "Get EFT messages by message type", description = "Get EFT messages by message type")
    public ResponseEntity<List<BankservAfricaEftMessage>> getEftMessagesByMessageType(
        ...
        List<BankservAfricaEftMessage> messages = eftProcessingService.getEftMessagesByMessageType(messageType);
    ...
    @Operation(summary = "Get EFT messages created after timestamp", description = "Get EFT messages created after timestamp")
    public ResponseEntity<List<BankservAfricaEftMessage>> getEftMessagesCreatedAfter(
        ...
        List<BankservAfricaEftMessage> messages = eftProcessingService.getEftMessagesCreatedAfter(
    ...
    @Operation(summary = "Get EFT messages by batch ID and direction", description = "Get EFT messages by batch ID and direction")
    public ResponseEntity<List<BankservAfricaEftMessage>> getEftMessagesByBatchIdAndDirection(
        ...
        List<BankservAfricaEftMessage> messages = eftProcessingService.getEftMessagesByBatchIdAndDirection(batchId, direction);
    ...
    @Operation(summary = "Count EFT messages by batch ID", description = "Count EFT messages by batch ID")
    ...
    @Operation(summary = "Count EFT messages by batch ID and status", description = "Count EFT messages by batch ID and status")
