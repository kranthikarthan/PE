 ...
 *
 * <p>REST controller for BankservAfrica performance optimization operations: - Performance metrics
...
@Tag(
    name = "BankservAfrica Performance",
    description = "BankservAfrica performance optimization operations")
public class BankservAfricaPerformanceController {

  private final BankservAfricaPerformanceOptimizationService
      bankservAfricaPerformanceOptimizationService;
  ...
  public ResponseEntity<Map<String, Object>> getPerformanceMetrics() {
    ...
    Map<String, Object> metrics =
        bankservAfricaPerformanceOptimizationService.getPerformanceMetrics();
  ...
  public ResponseEntity<Map<String, Object>> getOptimizationRecommendations() {
    ...
    Map<String, Object> recommendations =
        bankservAfricaPerformanceOptimizationService.getOptimizationRecommendations();
  ...
  public ResponseEntity<Map<String, Object>> evictAdapterCache(@PathVariable String adapterId) {
    ...
    Map<String, Object> result =
        Map.of(
            ...
            "SUCCESS",
            "message",
            "BankservAfrica adapter cache evicted successfully",
            "adapterId",
            adapterId,
            "timestamp",
