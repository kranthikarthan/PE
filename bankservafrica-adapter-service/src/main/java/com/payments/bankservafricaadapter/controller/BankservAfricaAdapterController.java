...
public class BankservAfricaAdapterController {
  ...
  @PostMapping
  @Operation(
      summary = "Create BankservAfrica adapter",
      description = "Create a new BankservAfrica clearing adapter")
  ...
  @Operation(
      ...
      description = "Update BankservAfrica adapter configuration")
  ...
  public ResponseEntity<BankservAfricaAdapter> activateBankservAfricaAdapter(
    ...
    BankservAfricaAdapter adapter =
        adapterService.activateAdapter(ClearingAdapterId.of(adapterId), request.getActivatedBy());
  ...
  public ResponseEntity<BankservAfricaAdapter> deactivateBankservAfricaAdapter(
    ...
    BankservAfricaAdapter adapter =
        adapterService.deactivateAdapter(
  ...
  public ResponseEntity<BankservAfricaAdapter> getBankservAfricaAdapter(
    ...
    Optional<BankservAfricaAdapter> adapter =
        adapterService.findById(ClearingAdapterId.of(adapterId));
  ...
  @Operation(
      ...
      description = "Get BankservAfrica adapters by tenant ID")
  ...
  @Operation(
      summary = "Get adapters by tenant and business unit",
      description = "Get BankservAfrica adapters by tenant ID and business unit")
  public ResponseEntity<List<BankservAfricaAdapter>>
      getBankservAfricaAdaptersByTenantAndBusinessUnit(
          @PathVariable @Parameter(description = "Tenant ID") String tenantId,
          @PathVariable @Parameter(description = "Business Unit ID") String businessUnitId) {

    log.info(
        "Getting BankservAfrica adapters for tenant: {} and business unit: {}",
        tenantId,
        businessUnitId);

    List<BankservAfricaAdapter> adapters =
        adapterService.findByTenantIdAndBusinessUnitId(tenantId, businessUnitId);
  ...
  @Operation(
      ...
      description = "Get active BankservAfrica adapters by tenant ID")
  ...
  @Operation(
      summary = "Get adapters by network",
      description = "Get BankservAfrica adapters by network")
  ...
  @Operation(
      summary = "Get adapters by status",
      description = "Get BankservAfrica adapters by status")
