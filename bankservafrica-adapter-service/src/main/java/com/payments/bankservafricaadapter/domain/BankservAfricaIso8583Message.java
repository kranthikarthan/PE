 ...
 *
 * <p>Represents ISO 8583 messages for BankservAfrica processing:
 * - Card transaction processing
 * - Message type identification (MTI)
...
public class BankservAfricaIso8583Message {
    ...
    public static BankservAfricaIso8583Message create(
        ...
        if (transactionId == null || transactionId.isBlank()) {
            throw new InvalidBankservAfricaIso8583MessageException("Transaction ID cannot be null or blank");
        }
        ...
        if (processingCode == null || processingCode.isBlank()) {
            throw new InvalidBankservAfricaIso8583MessageException("Processing code cannot be null or blank");
        }
