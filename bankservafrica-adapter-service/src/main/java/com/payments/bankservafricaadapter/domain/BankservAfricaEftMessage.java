 ...
 *
 * <p>Represents EFT batch messages for BankservAfrica processing:
...
public class BankservAfricaEftMessage {
     ...
     */
    public void updateStatus(String status, Integer statusCode, String errorCode, String errorMessage) {
        this.status = status;
