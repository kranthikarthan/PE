 ...
 *
 * <p>Represents transaction logs for BankservAfrica processing: - Operation audit trail -
 * Performance monitoring - Error tracking - Processing time measurement
 */
@Entity
...
public class BankservAfricaTransactionLog {
  ...
  public static BankservAfricaTransactionLog create(
    ...
    if (transactionId == null || transactionId.isBlank()) {
      throw new InvalidBankservAfricaTransactionLogException(
          "Transaction ID cannot be null or blank");
    }
    if (messageType == null || messageType.isBlank()) {
      throw new InvalidBankservAfricaTransactionLogException(
          "Message type cannot be null or blank");
    }
