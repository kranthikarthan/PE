 ...
 *
 * <p>Represents settlement records for BankservAfrica processing:
...
public class BankservAfricaSettlementRecord {
    ...
    public static BankservAfricaSettlementRecord create(
        ...
        if (currencyCode == null || currencyCode.isBlank()) {
            throw new InvalidBankservAfricaSettlementRecordException("Currency code cannot be null or blank");
        }
        if (transactionCount == null || transactionCount < 0) {
            throw new InvalidBankservAfricaSettlementRecordException("Transaction count cannot be negative");
        }
    ...
    public BigDecimal getAverageTransactionAmount() {
        ...
        return this.totalAmount.divide(BigDecimal.valueOf(this.transactionCount), 2, BigDecimal.ROUND_HALF_UP);
    }
}
