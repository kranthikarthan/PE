 ...
 *
 * <p>Represents ACH transactions for BankservAfrica processing: - ACH batch processing - Originator
 * and receiver information - Settlement tracking - Return code handling
 */
@Entity
...
public class BankservAfricaAchTransaction {
  ...
  public static BankservAfricaAchTransaction create(
    ...
    if (achBatchId == null || achBatchId.isBlank()) {
      throw new InvalidBankservAfricaAchTransactionException(
          "ACH Batch ID cannot be null or blank");
    }
    ...
    if (traceNumber == null || traceNumber.isBlank()) {
      throw new InvalidBankservAfricaAchTransactionException(
          "Trace number cannot be null or blank");
    }
