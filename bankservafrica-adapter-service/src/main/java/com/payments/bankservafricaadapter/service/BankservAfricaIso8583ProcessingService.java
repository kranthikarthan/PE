...
public class BankservAfricaIso8583ProcessingService {
  ...
  public BankservAfricaIso8583Message processIso8583Message(
    ...
    BankservAfricaIso8583Message message =
        BankservAfricaIso8583Message.create(
    ...
    log.info(
        "Successfully processed ISO 8583 message: {} with transaction ID: {}",
        message.getId(),
        transactionId);
  ...
  public BankservAfricaIso8583Message updateIso8583MessageDetails(
    ...
    BankservAfricaIso8583Message message =
        iso8583MessageRepository
            .findById(messageId)
            .orElseThrow(
                () -> new IllegalArgumentException("ISO 8583 message not found: " + messageId));
  ...
  public BankservAfricaIso8583Message updateIso8583MessageStatus(
      ClearingMessageId messageId, String status, String responseCode) {
  ...
  /** Set raw message */
  @Transactional
  public BankservAfricaIso8583Message setRawMessage(
      ClearingMessageId messageId, String rawMessage) {
  ...
  public Optional<BankservAfricaIso8583Message> getIso8583MessageByTransactionId(
      String transactionId) {
    BankservAfricaIso8583Message message =
        iso8583MessageRepository.findByTransactionId(transactionId);
    return Optional.ofNullable(message);
  }

  /** Get ISO 8583 messages by adapter ID */
  public List<BankservAfricaIso8583Message> getIso8583MessagesByAdapterId(
      ClearingAdapterId adapterId) {
  ...
  public List<BankservAfricaIso8583Message> getIso8583MessagesByProcessingCode(
      String processingCode) {
  ...
  public List<BankservAfricaIso8583Message> getIso8583MessagesByAmountRange(
  ...
  public List<BankservAfricaIso8583Message> getIso8583MessagesCreatedAfter(
