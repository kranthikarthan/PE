 ...
 *
 * <p>Tracks all IAM operations for compliance (POPIA, FICA, PCI-DSS):
 * - Who accessed what
 * - When they accessed it
 * - Result (SUCCESS, DENIED, ERROR)
 * - Detailed reason for denial/error
 *
 * <p>Never modified after creation. Retention: 90 days minimum.
 */
@Entity
@Table(
    name = "audit_logs",
