 ...
 * 
 * Unit tests for AccountAdapterService:
...
class AccountAdapterServiceTest {
    ...
    @Mock
    private AccountServiceFallback accountServiceFallback;
    ...
    @BeforeEach
    void setUp() {
        accountAdapterService = new AccountAdapterService(
    ...
    void testGetAccountBalance_Success() {
        ...
        // When
        CompletableFuture<AccountBalanceResponse> result = accountAdapterService.getAccountBalance(
    ...
    void testGetAccountBalance_WithCacheHit() {
        ...
        when(accountCacheService.getCachedAccountBalance(accountNumber, tenantId)).thenReturn(cachedResponse);
    ...
    void testValidateAccount_Success() {
        ...
        // When
        CompletableFuture<AccountValidationResponse> result = accountAdapterService.validateAccount(
                accountNumber, tenantId, businessUnitId, correlationId);
    ...
    void testValidateAccount_WithCacheHit() {
        ...
        when(accountCacheService.getCachedAccountValidation(accountNumber, tenantId)).thenReturn(cachedResponse);
    ...
    void testGetAccountStatus_Success() {
        ...
        // When
        CompletableFuture<AccountStatusResponse> result = accountAdapterService.getAccountStatus(
                accountNumber, tenantId, businessUnitId, correlationId);
    ...
    void testGetAccountStatus_WithCacheHit() {
        ...
        when(accountCacheService.getCachedAccountStatus(accountNumber, tenantId)).thenReturn(cachedResponse);
