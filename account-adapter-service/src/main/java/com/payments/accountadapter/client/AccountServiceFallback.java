 ...
 *
 * <p>Fallback implementation for account service client: - Circuit breaker fallback - Error
...
public class AccountServiceFallback implements AccountServiceClient {
  ...
  public AccountBalanceResponse getAccountBalance(
      AccountBalanceRequest request, String authorization, String correlationId, String tenantId) {

    log.warn(
        "Account service fallback triggered for balance request: {} with correlation: {}",
  ...
  public AccountValidationResponse validateAccount(
    ...
    log.warn(
        "Account service fallback triggered for validation request: {} with correlation: {}",
        request.getAccountNumber(),
        correlationId);
  ...
  public AccountStatusResponse getAccountStatus(
      AccountStatusRequest request, String authorization, String correlationId, String tenantId) {

    log.warn(
        "Account service fallback triggered for status request: {} with correlation: {}",
        request.getAccountNumber(),
        correlationId);
