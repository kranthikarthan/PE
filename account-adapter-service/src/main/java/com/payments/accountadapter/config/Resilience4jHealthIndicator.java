...
public class Resilience4jHealthIndicator implements HealthIndicator {
    ...
    private Map<String, Object> checkCircuitBreakerHealth() {
        ...
        try {
            ...
            health.put("numberOfSuccessfulCalls", circuitBreaker.getMetrics().getNumberOfSuccessfulCalls());
    ...
    private Map<String, Object> checkTimeLimiterHealth() {
        ...
        try {
            ...
            health.put("cancelRunningFuture", timeLimiter.getTimeLimiterConfig().getCancelRunningFuture());
