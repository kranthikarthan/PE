 ...
 * 
 * Maps and transforms errors for consistent handling:
...
public class ErrorMappingService {
    ...
    private static final Map<String, ErrorMapping> ERROR_MAPPINGS = Map.of(
            "account_validation", new ErrorMapping("ACCOUNT_VALIDATION_ERROR", "VALIDATION_ERROR", "Account validation failed"),
            "account_status", new ErrorMapping("ACCOUNT_STATUS_ERROR", "SERVICE_ERROR", "Account status retrieval failed"),
            "account_balance", new ErrorMapping("ACCOUNT_BALANCE_ERROR", "SERVICE_ERROR", "Account balance retrieval failed"),
            "oauth_token", new ErrorMapping("OAUTH_TOKEN_ERROR", "AUTHENTICATION_ERROR", "OAuth2 token acquisition failed"),
            "cache_error", new ErrorMapping("CACHE_ERROR", "INFRASTRUCTURE_ERROR", "Cache operation failed"),
            "circuit_breaker", new ErrorMapping("CIRCUIT_BREAKER_ERROR", "RESILIENCE_ERROR", "Circuit breaker opened"),
            "timeout", new ErrorMapping("TIMEOUT_ERROR", "PERFORMANCE_ERROR", "Operation timed out"),
            "network", new ErrorMapping("NETWORK_ERROR", "CONNECTIVITY_ERROR", "Network communication failed")
    );
    ...
    public AccountServiceException mapError(Throwable throwable, String operation, 
        ...
        log.error("Mapped error with context: {} - {} for operation: {} (account: {}, tenant: {})", 
                errorCode, errorMessage, operation, accountNumber, tenantId);
