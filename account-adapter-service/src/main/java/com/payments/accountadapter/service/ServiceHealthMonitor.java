 ...
 * 
 * Monitors health of all service components:
 * - External account service health
 * - Redis cache health
 * - OAuth2 token service health
...
public class ServiceHealthMonitor implements HealthIndicator {
    ...
    public Map<String, Object> getDetailedHealth() {
        ...
        try {
            ...
            // Overall status
            boolean overallHealthy = (Boolean) health.get("redis") instanceof Map && 
