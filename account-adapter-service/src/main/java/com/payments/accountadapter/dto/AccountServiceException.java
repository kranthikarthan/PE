 ...
 *
 * <p>Custom exception for account service errors: - Error details - Error codes - Request context -
 * Service information
 */
@Getter
public class AccountServiceException extends RuntimeException {
  ...
  public AccountServiceException(
      String message, Throwable cause, String errorCode, String errorType) {
    super(message, cause);
    this.errorCode = errorCode;
    this.errorType = errorType;
    this.correlationId = null;
