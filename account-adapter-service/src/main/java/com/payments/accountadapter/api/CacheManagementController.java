 ...
 *
 * <p>REST controller for cache management operations: - Cache statistics - Cache clearing - Token
 * management - Cache health
 */
@Slf4j
@RestController
...
public class CacheManagementController {
  ...
  @Operation(
      ...
      description = "Retrieve cache statistics and metrics")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<Map<String, Object>> clearTenantCache(
    ...
    return ResponseEntity.ok(
        Map.of(
            "message",
            "Tenant cache cleared successfully",
            "tenantId",
            tenantId,
            "timestamp",
            System.currentTimeMillis()));
  ...
  public ResponseEntity<Map<String, Object>> clearAllCache() {
    ...
    return ResponseEntity.ok(
        Map.of(
            "message", "All cache cleared successfully", "timestamp", System.currentTimeMillis()));
  }
  ...
  public ResponseEntity<Map<String, Object>> clearTokenCache() {
    ...
    return ResponseEntity.ok(
        Map.of(
            "message",
            "OAuth2 token cache cleared successfully",
            "timestamp",
            System.currentTimeMillis()));
  }
