...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleAccountServiceException(
        ...
        Map<String, Object> errorResponse = Map.of(
                ...
                "correlationId", ex.getCorrelationId() != null ? ex.getCorrelationId() : "unknown",
                "requestId", ex.getRequestId() != null ? ex.getRequestId() : "unknown",
                "accountNumber", ex.getAccountNumber() != null ? ex.getAccountNumber() : "unknown",
                "tenantId", ex.getTenantId() != null ? ex.getTenantId() : "unknown",
    ...
    public ResponseEntity<Map<String, Object>> handleCompletionException(
        ...
        Map<String, Object> errorResponse = Map.of(
                ...
                "errorMessage", "Asynchronous operation failed: " + ex.getMessage(),
