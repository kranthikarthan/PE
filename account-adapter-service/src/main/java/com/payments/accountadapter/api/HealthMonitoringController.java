...
public class HealthMonitoringController {
    ...
    public ResponseEntity<Map<String, Object>> getHealth() {
        ...
        boolean isHealthy = (Boolean) health.get("overall") instanceof Map && 
    ...
    @Operation(summary = "Get component health", description = "Retrieve health status of individual components")
    @ApiResponses(value = {
