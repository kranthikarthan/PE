 ...
 *
 * <p>This entity represents settlement alerts that are generated based on monitoring thresholds and
 * conditions. It provides comprehensive alert management including alert generation, notification,
 * and tracking.
 *
 * @since PE-411
 */
...
public class SettlementAlert {
  ...
  public String getSummary() {
    return String.format("Alert[%s] %s - %s (%s)", alertId, alertName, severity, status);
  }
}
