 ...
 * Rule Type Enum
 *
 * <p>Represents the type of validation rule: - BUSINESS: Business logic rules - COMPLIANCE:
 * Regulatory compliance rules - FRAUD: Fraud detection rules - RISK: Risk assessment rules
 */
