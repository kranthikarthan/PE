 ...
 *
 * <p>Represents a validation rule that failed: - Rule identification - Failure reason - Failure
...
public class FailedRule {
  ...
  public static FailedRule create(
      String ruleId, String ruleName, String ruleType, String failureReason, String field) {
  ...
  public static FailedRule create(
      String ruleId, String ruleName, String ruleType, String failureReason) {
