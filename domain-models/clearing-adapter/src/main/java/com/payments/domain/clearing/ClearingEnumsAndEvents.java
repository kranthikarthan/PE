...
class ClearingAdapterCreatedEvent implements DomainEvent {
    ...
    @Override public String getEventType() { return "ClearingAdapterCreated"; }
    @Override public Instant getOccurredAt() { return createdAt; }
}
...
class ClearingRouteAddedEvent implements DomainEvent {
    ...
    @Override public String getEventType() { return "ClearingRouteAdded"; }
...
class ClearingMessageLoggedEvent implements DomainEvent {
    ...
    @Override public String getEventType() { return "ClearingMessageLogged"; }
    @Override public Instant getOccurredAt() { return Instant.now(); }
}
...
class ClearingAdapterConfigurationUpdatedEvent implements DomainEvent {
    ...
    @Override public String getEventType() { return "ClearingAdapterConfigurationUpdated"; }
    @Override public Instant getOccurredAt() { return Instant.now(); }
}
...
class ClearingAdapterActivatedEvent implements DomainEvent {
    ...
    @Override public String getEventType() { return "ClearingAdapterActivated"; }
    @Override public Instant getOccurredAt() { return Instant.now(); }
}
...
class ClearingAdapterDeactivatedEvent implements DomainEvent {
    ...
    @Override public String getEventType() { return "ClearingAdapterDeactivated"; }
    @Override public Instant getOccurredAt() { return Instant.now(); }
}

class InvalidClearingAdapterException extends RuntimeException {
    public InvalidClearingAdapterException(String message) { super(message); }
}
