...
/**
 * JPA entity for Payment - contains infrastructure concerns
 * This is the persistence representation of the domain Payment entity
 */
@Entity
...
public class PaymentEntity {
    ...
    public static PaymentEntity fromDomain(Payment payment) {
        return PaymentEntity.builder()
            ...
            .clearingReference(payment.getClearingReference() != null ? payment.getClearingReference().getValue() : null)
    ...
    public Payment toDomain() {
        ...
        payment.setAmount(Money.of(this.amount, this.currency));
        ...
        payment.setClearingReference(this.clearingReference != null ? ClearingSystemReference.of(this.clearingReference) : null);
        ...
        if (this.statusHistory != null) {
            payment.setStatusHistory(this.statusHistory.stream()
                .map(PaymentStatusHistoryEntity::toDomain)
                .toList());
        }
        
        // Convert clearing confirmations
        if (this.clearingConfirmations != null) {
            payment.setClearingConfirmations(this.clearingConfirmations.stream()
