...
class TransactionCreatedEvent implements DomainEvent {
    ...
    @Override public String getEventType() { return "TransactionCreated"; }
...
class TransactionProcessingEvent implements DomainEvent {
    ...
    @Override public String getEventType() { return "TransactionProcessing"; }
...
class TransactionClearingEvent implements DomainEvent {
    ...
    @Override public String getEventType() { return "TransactionClearing"; }
    @Override public Instant getOccurredAt() { return Instant.now(); }
}
...
class TransactionCompletedEvent implements DomainEvent {
    ...
    @Override public String getEventType() { return "TransactionCompleted"; }
...
class TransactionFailedEvent implements DomainEvent {
    ...
    @Override public String getEventType() { return "TransactionFailed"; }
    @Override public Instant getOccurredAt() { return Instant.now(); }
}
