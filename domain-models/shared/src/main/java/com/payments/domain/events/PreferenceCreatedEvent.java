...
public class PreferenceCreatedEvent implements DomainEvent {
    ...
    public PreferenceCreatedEvent(PreferenceId preferenceId, TenantId tenantId, String userId, NotificationType type, NotificationChannel channel, Instant occurredAt) {
