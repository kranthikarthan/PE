...
public class PreferenceUpdatedEvent implements DomainEvent {
    ...
    public PreferenceUpdatedEvent(PreferenceId preferenceId, TenantId tenantId, String userId, NotificationType type, NotificationChannel channel, Instant occurredAt) {
