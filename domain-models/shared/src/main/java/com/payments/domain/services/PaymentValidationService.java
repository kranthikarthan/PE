...
import com.payments.domain.exceptions.InvalidPaymentException;
 ...
 * Contains business rules for payment validation
 */
public class PaymentValidationService {
    ...
    public ValidationResult validatePayment(Payment payment) {
        ...
        // Account validation
        if (payment.getBeneficiaryAccount() == null || payment.getBeneficiaryAccount().trim().isEmpty()) {
        ...
        if (payment.getBeneficiaryBankCode() == null || payment.getBeneficiaryBankCode().trim().isEmpty()) {
