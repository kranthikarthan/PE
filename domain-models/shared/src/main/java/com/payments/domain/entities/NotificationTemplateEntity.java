...
/**
 * Pure domain entity for Notification Template - no infrastructure dependencies
...
public class NotificationTemplateEntity extends AggregateRoot<TemplateId> {
    ...
    public NotificationTemplateEntity(TemplateId templateId, TenantId tenantId, String name,
                                      NotificationType type, NotificationChannel channel,
                                      String subject, String content, Map<String, Object> variables,
                                      String createdBy) {
        if (templateId == null || tenantId == null || name == null || type == null ||
                channel == null || subject == null || content == null || createdBy == null) {
        ...
        addDomainEvent(new TemplateCreatedEvent(templateId, tenantId, name, type, channel, this.createdAt));
    }

    // Private constructor for re-hydration from persistence (used by infrastructure layer)
    private NotificationTemplateEntity(TemplateId templateId, TenantId tenantId, String name,
                                       NotificationType type, NotificationChannel channel,
                                       String subject, String content, Map<String, Object> variables,
    ...
    public void updateTemplate(String name, String subject, String content,
                               Map<String, Object> variables, String updatedBy) {
        if (!this.isActive) {
