...
public class NotificationDeliveredEvent implements DomainEvent {
    ...
    public NotificationDeliveredEvent(NotificationId notificationId, TenantId tenantId, NotificationType type, NotificationChannel channel, Instant occurredAt) {
