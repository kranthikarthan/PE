...
public class PaymentClearedEvent implements DomainEvent {
    ...
    public PaymentClearedEvent(PaymentId paymentId, TenantId tenantId, Money amount, ClearingConfirmation confirmation) {
    ...
    public PaymentClearedEvent(PaymentId paymentId, TenantId tenantId, Money amount, ClearingConfirmation confirmation, Instant occurredAt) {
        this.paymentId = paymentId;
        this.tenantId = tenantId;
        this.amount = amount;
        this.confirmation = confirmation;
