...
public class ConfigurationController {
  ...
  public Map<String, Object> clearSecretCache() {
    ...
    return Map.of("message", "Secret cache cleared", "timestamp", System.currentTimeMillis());
  }
  ...
  public Map<String, Object> getConfigurationHealth() {
    ...
    boolean healthy =
        databaseConfigured && cacheConfigured && messagingConfigured && securityConfigured;
