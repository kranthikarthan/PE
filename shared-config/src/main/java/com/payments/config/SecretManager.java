...
@ConditionalOnProperty(
    name = "payments.security.encryption.enabled",
    havingValue = "true",
    matchIfMissing = true)
  ...
  public String encrypt(String plainText) {
    try {
      SecretKeySpec secretKey =
          new SecretKeySpec(Base64.getDecoder().decode(encryptionKey), algorithm);
    ...
    try {
      javax.crypto.spec.PBEKeySpec spec =
          new javax.crypto.spec.PBEKeySpec(
              value.toCharArray(), salt.getBytes(StandardCharsets.UTF_8), iterations, keyLength);
