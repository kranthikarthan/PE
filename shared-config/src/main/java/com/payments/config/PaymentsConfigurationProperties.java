...
public class PaymentsConfigurationProperties {
    ...
    public static class Messaging {
        ...
        public static class Kafka {
            ...
            @NotBlank
            private String groupId = "payments-engine";

            @NotBlank
            private String clientId = "payments-engine-client";
    ...
    public static class Security {
        ...
        public static class Jwt {
            ...
            @NotBlank
            private String issuer = "payments-engine";

            @NotBlank
            private String audience = "payments-engine";
        ...
        public static class OAuth2 {
            ...
            @Positive
            private long refreshTokenValiditySeconds = 86400;
        }
    ...
    public static class Telemetry {
        ...
        public static class Tracing {
            ...
            @NotBlank
            private String serviceName = "payments-engine";
        ...
        public static class Logging {
            ...
            public static class File {
                @NotBlank
                private String path = "logs/payments-engine.log";
    ...
    public static class Services {
        @Valid
        private PaymentInitiation paymentInitiation = new PaymentInitiation();
        ...
        @Valid
        private SagaOrchestrator sagaOrchestrator = new SagaOrchestrator();
    ...
    public static class Profiles {
        ...
        @Valid
        private Map<String, ProfileConfig> environments = Map.of(
