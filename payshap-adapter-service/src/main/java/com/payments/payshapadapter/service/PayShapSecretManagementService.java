 ...
 *
 * <p>Service for managing PayShap adapter secrets and secure configuration: - API keys management -
...
public class PayShapSecretManagementService {
  ...
  public String getApiKey(TenantContext tenantContext) {
    String key =
        "PAYSHAP_API_KEY_" + tenantContext.getTenantId() + "_" + tenantContext.getBusinessUnitId();
  ...
  public void storeApiKey(TenantContext tenantContext, String apiKey) {
    ...
    log.info(
        "Stored PayShap API key for tenant: {} and business unit: {}",
  ...
  public void storeOAuth2Credentials(
    ...
    log.info(
        "Stored PayShap OAuth2 credentials for tenant: {} and business unit: {}",
        tenantContext.getTenantId(),
        tenantContext.getBusinessUnitId());
  }
  ...
  public void storeEncryptionKey(TenantContext tenantContext, String encryptionKey) {
    ...
    log.info(
        "Stored PayShap encryption key for tenant: {} and business unit: {}",
        tenantContext.getTenantId(),
        tenantContext.getBusinessUnitId());
  }
  ...
  public void storeEndpointUrl(TenantContext tenantContext, String endpointUrl) {
    ...
    log.info(
        "Stored PayShap endpoint URL for tenant: {} and business unit: {}",
        tenantContext.getTenantId(),
        tenantContext.getBusinessUnitId());
  }
  ...
  public void storeCertificate(TenantContext tenantContext, String certificate) {
    ...
    log.info(
        "Stored PayShap certificate for tenant: {} and business unit: {}",
        tenantContext.getTenantId(),
        tenantContext.getBusinessUnitId());
  }
  ...
  public void removeAllSecrets(TenantContext tenantContext) {
    ...
    log.info(
        "Removed all PayShap secrets for tenant: {} and business unit: {}",
        tenantContext.getTenantId(),
        tenantContext.getBusinessUnitId());
  }
}
