...
/**
 * Configuration management controller for PayShap adapter Extends shared ConfigurationController
 * with adapter-specific endpoints
 */
@RestController
...
public class PayShapConfigurationController {
  ...
  public Map<String, Object> getAdapterHealth() {
    ...
    boolean endpointConfigured =
        payShapAdapterConfig.getEndpoint() != null && !payShapAdapterConfig.getEndpoint().isEmpty();
    boolean amountLimitConfigured =
        payShapAdapterConfig.getAmountLimit() != null && payShapAdapterConfig.getAmountLimit() > 0;
    boolean encryptionConfigured = payShapAdapterConfig.getEncryptionEnabled() != null;
    boolean timeoutConfigured =
        payShapAdapterConfig.getTimeoutSeconds() != null
            && payShapAdapterConfig.getTimeoutSeconds() > 0;
  ...
  public Map<String, Object> getAdapterSecurityConfiguration() {
    ...
    return Map.of(
        ...
        "retryAttempts", payShapAdapterConfig.getRetryAttempts(),
        "hasEncryption",
            payShapAdapterConfig.getEncryptionEnabled() != null
                && payShapAdapterConfig.getEncryptionEnabled());
  }
