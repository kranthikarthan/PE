...
/**
 * PayShap Environment Configuration
 *
 * <p>Environment-specific configuration for PayShap adapter: - Development environment settings -
 * Staging environment settings - Production environment settings - Environment-specific endpoints
 * and credentials
 */
@Data
@Configuration
@ConfigurationProperties(prefix = "payshap.environment")
public class PayShapEnvironmentConfig {
    ...
    switch (environment.toLowerCase()) {
      ...
      case "dev":
        return EnvironmentSettings.builder()
            ...
            .amountLimit(development.getAmountLimit())
      ...
      case "stage":
        return EnvironmentSettings.builder()
            ...
            .amountLimit(staging.getAmountLimit())
      ...
      case "prod":
        return EnvironmentSettings.builder()
            ...
            .amountLimit(production.getAmountLimit())
